...
public class FFmpegKitFlutterPlugin implements FlutterPlugin, ActivityAware, MethodCallHandler, EventChannel.StreamHandler, PluginRegistry.ActivityResultListener {
    ...
    // NOTE: the v1-embedding registerWith(Registrar) entry point was removed.
    // Flutter 3.47 no longer ships io.flutter.plugin.common.PluginRegistry.Registrar,
    // and this plugin is only ever attached via the v2 FlutterPlugin/ActivityAware
    // lifecycle (see onAttachedToActivity below).
